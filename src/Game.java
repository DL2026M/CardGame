...
public class Game {
    ...
    public Game() {
        ...
        System.out.println("Player 1, Enter your game name: ");
        String playerName1 = input.nextLine();
        System.out.println("Player 2, Enter your game name: ")
    ...
    public int bettingAmountPlayer1() {
            Scanner input = new Scanner(System.in);
            System.out.println(player1 + " Enter how much you want to bet on this round of blackjack." +
    ...
    public int bettingAmountPlayer2() {
            Scanner input = new Scanner(System.in);
            System.out.println(player2 + " Enter how much you want to bet on this round of blackjack." +
                    " Only integers are valid to bet. Place your bet: $ ");
